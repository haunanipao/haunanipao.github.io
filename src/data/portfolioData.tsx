...
export const hero = {
  ...
  description:
    "Seasoned Product Designer blending UX and community to craft user-centric web experiences. Career spans product, enterprise, SaaS consultancy, startups, and government across the US, NZ, and Australia.",
  connect: "Find me:",
...
export const myArtIntro = {
    ...
    alt: "I had a little time to draw an abstract sunset on the beach. Created with acrylic posca and molotow markers in my Leuchtterm 1917 notebook. Analog ftw.",
  };
