...
export const myArtIntro = {
    ...
    src: ImageMyArt,
    alt: "Rangitoto island in Auckland, Matariki Whetū (Pleiades Stars) and Kāne - the 27th day of the Hawaiian Lunar Calendar This is the rising of a waning crescent of Ka Mahina (The Moon), near dawn on 10 July, 2026 and marks one of my favourite NZ holidays - Matariki. Inspired by Vincent Van Gogh's Starry Night. Drawn in Procreate. Language Māori, Hawaiian and English used together to suit me, so apology for the using them a little haphazardly 😉.",
  };
