...
export const Logo = () => (
  ...
  >
    <div className="relative w-11 h-11 flex items-center justify-center">
      <div
        className="absolute inset-0 rounded-xl opacity-30 group-hover:opacity-60 transition-opacity duration-500"
      ...
      <svg className="relative z-10" width="44" height="44" viewBox="0 0 40 40" fill="none">
        ...
        <circle cx="29" cy="26" r="2" fill={colours.secondary} className="animate-pulse" />
      </svg>
    </div>
    <span className="font-bold text-xl tracking-tight transition-colors duration-200" style={{ color: colours.text, fontFamily: "'Fraunces', sans-serif" }}>
      Haunani <span style={{ color: colours.primary }}>Pao</span>
    </span>
  </div>
);