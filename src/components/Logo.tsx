  ...
  >
    <div className="relative w-11 h-11 flex items-center justify-center">
      ...
      <svg className="relative z-10" width="44" height="44" viewBox="0 0 40 40" fill="none">
        ...
        <path d="M20 12V28" stroke="var(--primary)" strokeWidth="2.5" strokeLinecap="round" />
        <path d="M20 12H25C27.2 12 29 13.8 29 16C29 18.2 27.2 20 25 20H20" stroke="var(--primary)" strokeWidth="2.5" strokeLinecap="round" />
